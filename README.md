...
基于 [Codex Dream Skin](https://github.com/Fei-Away/Codex-Dream-Skin) 的个人定制主题，包含三个从 Wallpaper Engine 壁纸制作的自定义背景：
...
背景源文件来自 Wallpaper Engine 创意工坊作品（紫罗兰 3022080536 / 夏日Miku 3484246124 / 日落猫 3373818743），仅供个人复现使用；如需公开分发请自行确认素材授权。
