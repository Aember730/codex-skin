...
基于 [Codex Dream Skin](https://github.com/Fei-Away/Codex-Dream-Skin) 的个人定制主题，包含两个从 Wallpaper Engine 壁纸制作的自定义背景：
...
- `sources/` — 两个壁纸的源文件（纯背景、人物层、官方预览图等）
...
背景源文件来自 Wallpaper Engine 创意工坊作品（紫罗兰 3022080536 / 夏日Miku 3484246124），仅供个人复现使用；如需公开分发请自行确认素材授权。
